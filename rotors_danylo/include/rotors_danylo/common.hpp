#ifndef INCLUDE_ROTORS_DANYLO_COMMON_HPP_
#define INCLUDE_ROTORS_DANYLO_COMMON_HPP_
...
struct EigenOdometry {
  // Structure for odometry message
  EigenOdometry()
...
struct EigenIMU {
  // Structure for IMU message
  EigenIMU()
      : orientation(Eigen::Quaterniond::Identity()),
        angular_velocity(0.0, 0.0, 0.0),
        linear_acceleration(0.0, 0.0, 0.0) {};

  EigenIMU(const Eigen::Quaterniond& _orientation,
           const Eigen::Vector3d& _angular_velocity,
  ...
  Eigen::Quaterniond orientation;
  Eigen::Vector3d angular_velocity;
  Eigen::Vector3d linear_acceleration; // Acceleration is expressed in the Bode frame!
};

inline void eigenIMUFromMsg(const sensor_msgs::ImuConstPtr& msg,
                                 EigenIMU* imu) {
...
#endif // INCLUDE_ROTORS_DANYLO_COMMON_HPP_
